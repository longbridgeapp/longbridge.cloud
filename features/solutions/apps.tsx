    ...
    return [
      {
        ...
        className: 'flex-1',
        desc: i18n.t('LONGPORT 是给FD，OB/EP客户提供的一款包括行情，资讯等完全免费的公版App。'),
        services: [
          {
          ...
          {
            name: i18n.t('如果用户在多家FD券商客户开户，LONGPORT提供子账户功能'),
          },
          {
            name: i18n.t('功能列表'),
            children: [
      ...
      },
      {
        ...
        desc: i18n.t('LONGPORT 是给FD，OB/EP客户提供的一款可定制的收费App'),
        services: [
          {
          ...
          {
            name: i18n.t('定制部分，包括logo，颜色，特殊需求可以与产品专家沟通。'),
          },
          {
            name: i18n.t('功能列表'),
            children: [
