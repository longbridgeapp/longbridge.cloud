  ...
  return useMemo(() => {
    return [
      ...
      },
      {
        ...
        desc: i18n.t(
          'WHALE 所有系统都是基于云端架构，并且 WHALE 是 SFC 目前唯一颁发 EDSP 之机构。Cloud Native保障了系统运营的高可靠性，同时免去了本地机房运维的高成本，每用户云资源月成本低于5港币；借助于亚马逊云以及阿里云科技巨头的强大的科技能力，有效的保护了系统以及数据的安全性；智能的三地实时灾备系统，可以在一分钟内自动切换线路；不用在非交易日做系统更新，WHALE可以随时热发布，以确保系统问题的实时修复，以及更优的产品体验第一时间触达用户。'
        ),
