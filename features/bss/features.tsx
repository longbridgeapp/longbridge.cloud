        ...
        features: [
          {
            ...
            picture: 'https://pub.lbctrl.com/files/202205/AJgLumJugrshwPfT/Vector__1_.png',
          },
          {
            title: i18n.t('bss_features_004'),
            desc: i18n.t('bss_features_005'),
            picture: 'https://pub.lbctrl.com/files/202205/4aPy3T1c2hBMbVhq/Vector__2_.png',
          },
          {
            title: i18n.t('bss_features_006'),
            desc: i18n.t('bss_features_007'),
            picture: 'https://pub.lbctrl.com/files/202205/drRdNRPiHkruGGQ8/Vector__3_.png',
          },
          {
            title: i18n.t('bss_features_008'),
            desc: i18n.t('bss_features_009'),
            picture: 'https://pub.lbctrl.com/files/202205/qxy48zQ8FUpmhthV/Vector__4_.png',
          },
          {
            title: i18n.t('bss_features_010'),
            desc: i18n.t('bss_features_011'),
            picture: 'https://pub.lbctrl.com/files/202205/JXUS4rjSDusvrdXi/Vector__5_.png',
          },
          {
            title: i18n.t('bss_features_012'),
            desc: i18n.t('bss_features_013'),
            picture: 'https://pub.lbctrl.com/files/202205/27TsgNFQDkdwps6R/Vector__6_.png',
          },
        ],
      },
      {
        ...
        features: [
          {
            ...
            picture: 'https://pub.lbctrl.com/files/202205/NKbVHSC4MPsjYTtD/Vector__7_.png',
          },
          {
            title: i18n.t('bss_features_017'),
            desc: i18n.t('bss_features_018'),
            picture: 'https://pub.lbctrl.com/files/202205/JRr82mvwpYDoZhGL/Vector__8_.png',
          },
          {
            title: i18n.t('bss_features_019'),
            desc: i18n.t('bss_features_020'),
            picture: 'https://pub.lbctrl.com/files/202205/2qm1tuJe1JhmoWUv/Vector__9_.png',
          },
          {
            title: i18n.t('bss_features_021'),
            desc: i18n.t('bss_features_022'),
            picture: 'https://pub.lbctrl.com/files/202205/A4ZCJubtSrzL4B8Q/Vector__10_.png',
          },
          {
            title: i18n.t('bss_features_023'),
            desc: i18n.t('bss_features_024'),
            picture: 'https://pub.lbctrl.com/files/202205/5ZrUSoMDCFxXVY9Q/Vector__11_.png',
          },
        ],
      },
    ]
