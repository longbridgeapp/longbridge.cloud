...
const tradeServiceImgMap: any = {
  architecture: {
    'en': 'https://assets.lbctrl.com/uploads/eb4b6cb3-4f35-4d75-9c48-b246b2785d15/architecture_en.png',
    'zh-CN': 'https://assets.lbctrl.com/uploads/a73b7d34-7661-4bd4-a848-521198c56003/us_stock_architecture_cn.png',
    'zh-HK': 'https://assets.lbctrl.com/uploads/c3141781-ae69-44a7-89f5-732df94b9993/us_stock_architecture_hk.png',
  },
  backend: {
    'en': 'https://assets.lbctrl.com/uploads/f45ba9d3-ef22-4d24-bf02-b7c978c00bd1/backend_en.png',
    'zh-CN': 'https://assets.lbctrl.com/uploads/4c9c9e5c-9ca4-459b-8592-41a1a0d6b5ee/backend_cn.png',
    'zh-HK': 'https://assets.lbctrl.com/uploads/6a5861b2-ba8d-4502-bd60-8b1434acaf9c/backend_hk.png',
  },
  trading_desk: {
    'en': 'https://assets.lbctrl.com/uploads/248eb5c7-5374-429c-9bc2-66a47195725b/trading_desk_en.png',
    'zh-CN': 'https://assets.lbctrl.com/uploads/1b2a0b29-5300-4082-8462-773b558af5a2/trading_desk_cn.png',
    'zh-HK': 'https://assets.lbctrl.com/uploads/f8826e4e-017c-4c61-aa6b-9175d6e6c89a/trading_desk_hk.png',
  },
  overnight: {
    'en': 'https://assets.lbctrl.com/uploads/bd0202aa-c2a4-4da5-8fd0-5bfe40a636cb/overnight_en.png',
    'zh-CN': 'https://assets.lbctrl.com/uploads/c64bce15-2fc1-4836-9887-57dc33c19cdd/overnight_cn.png',
    'zh-HK': 'https://assets.lbctrl.com/uploads/7499de51-5b5a-4c9a-9408-1a680cc3bfa5/overnight_hk.png',
  },
  order: {
    'en': 'https://assets.lbctrl.com/uploads/ceb62ae2-9a3c-448d-990d-6f62e2f8439c/order_en.png',
    'zh-CN': 'https://assets.lbctrl.com/uploads/b49bf46b-caff-430b-bbbe-bfb1819ba0e3/order_cn.png',
    'zh-HK': 'https://assets.lbctrl.com/uploads/71fc258c-27c1-45b1-9ca6-48669cf4484f/order_hk.png',
  },
  option: {
    'en': 'https://assets.lbctrl.com/uploads/779a2d32-f295-4e6f-9da5-5a2119982a85/option_en.png',
    'zh-CN': 'https://assets.lbctrl.com/uploads/db35a190-9056-440d-8911-64de06d5d0e7/option_cn.png',
    'zh-HK': 'https://assets.lbctrl.com/uploads/6269ff77-18d8-435e-977b-5305eff40d2a/option_hk.png',
  },
}
...
const UsStock = () => {
  ...
  const advantages: IAdvantageProps['data'] = [
    {
      icon: 'https://assets.lbctrl.com/uploads/90fb4d46-a837-476d-a1ab-0ad641bee500/solution_us_stock_advantage_1.png',
    ...
    {
      icon: 'https://assets.lbctrl.com/uploads/6fd446d2-5beb-4c4f-be40-6e25bf773589/solution_us_stock_advantage_3.png',
      title: i18n.t('pages_us_stock11'),
      list: [i18n.t('pages_us_stock12'), i18n.t('pages_us_stock13')],
    },
    {
      icon: 'https://assets.lbctrl.com/uploads/957a3767-9b92-41ac-acf2-97bc5080be0b/solution_us_stock_advantage_4.png',
  ...
  const solutions = [
    {
      icon: 'https://assets.lbctrl.com/uploads/ace54dbf-d4d3-4530-9ae6-c1aeac861c4c/solution_us_stock_advantage_5.png',
    ...
    {
      icon: 'https://assets.lbctrl.com/uploads/af0047cc-f5e3-43bd-8c6e-8853c2c4b9d9/solution_us_stock_advantage_6.png',
  ...
  const tradeServiceList = [
    {
      img: 'https://assets.lbctrl.com/uploads/974fd067-5e4a-497d-b4bd-c85ef3b118f0/stock.png',
