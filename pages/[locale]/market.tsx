...
const MarketPage = () => {
  ...
  return (
    ...
    >
      ...
      <MarketFeatures />
      <MarketServices />
      <ContactBanner title={i18n.t('Get Started With WHALE Market Data ')} desc={i18n.t('Try Whale Market Data for free, and explore all the tools and services you need to start')} />
    </PageLayout>
  )
}
